    ...
    <div class="p-6 md:p-8 space-y-6 max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-border shadow-sm">
            <div>
                ...
                <h2 class="font-display-lg text-display-lg text-on-surface tracking-tight">Tambah Supplier Baru</h2>
                <p class="font-body-md text-sm text-on-surface-variant mt-0.5">Lengkapi rincian identitas, kontak PIC, dan alamat mitra supplier baru.</p>
            </div>
            <div class="flex items-center gap-3 shrink-0">
                ...
                <button type="submit" form="create-supplier-form" class="bg-primary hover:bg-primary/90 text-white px-6 py-2.5 rounded-xl font-semibold flex items-center gap-2 shadow-lg shadow-primary/25 transition-all active:scale-95 text-sm">
