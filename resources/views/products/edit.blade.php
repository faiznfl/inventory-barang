    ...
    <div class="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-4 sm:p-6 rounded-2xl border border-border shadow-sm">
            <div>
                ...
                <h2 class="font-display-lg text-xl sm:text-display-lg text-on-surface tracking-tight">Edit Produk</h2>
                <p class="font-body-md text-xs sm:text-sm text-on-surface-variant mt-0.5">Silahkan perbarui data, foto, serta pengaturan stok barang di bawah ini.</p>
            </div>
            <div class="flex items-center gap-2 sm:gap-3 shrink-0 w-full sm:w-auto">
                ...
                <button type="submit" form="edit-product-form" class="flex-1 sm:flex-none justify-center bg-primary hover:bg-primary/90 text-white px-4 sm:px-6 py-2.5 rounded-xl font-semibold flex items-center gap-2 shadow-lg shadow-primary/25 transition-all active:scale-95 text-xs sm:text-sm">
